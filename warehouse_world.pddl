(define (domain warehouse)
 ...
 (:action startShipment
   ...
   (:action robotMove
        ...
        :effect (and (not (no-robot ?l2)) (not (at ?r ?l1)) (at ?r ?l2) (no-robot ?l1))
   )
   ...
   (:action robotMoveWithPallette
    ...
    (:action MoveItemFromPalleteToShipment
        ...
        :precondition (and (contains ?p ?si) (packing-at ?s ?l) (packing-location ?l) (at ?p ?l) (ships ?s ?o) (orders ?o ?si) (started ?s) (not (complete ?s)))
